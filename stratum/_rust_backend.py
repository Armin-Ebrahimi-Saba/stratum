...
normalize_l2_inplace = getattr(native, "normalize_l2_inplace_dense", None) if native else None
normalize_l1_inplace = getattr(native, "normalize_l1_inplace_dense", None) if native else None
normalize_max_inplace = getattr(native, "normalize_max_inplace_dense", None) if native else None
min_max_fit = getattr(native, "min_max_fit_dense", None) if native else None
